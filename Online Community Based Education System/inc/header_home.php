...
<body>
	<!-- header section start here -->
		<div class='container-fluid main-header-home'>
											...
											<div class="horizontal-line"></div>
												<div class="col-lg-4">
													<ul class="u-underline-style">
														...
														<li><a href="varsityDeptCourseList.php">গনিত</a></li>
													</ul>
												</div>
												<div class="col-lg-4">
													<ul class="u-underline-style">
														<li><a href="varsityDeptCourseList.php">রসায়ন</a></li>
														<li><a href="varsityDeptCourseList.php">পদার্থ</a></li> 
														<li><a href="varsityDeptCourseList.php">পরিসংখ্যান</a></li>
													</ul>
												</div>
												<div class="col-lg-4">
													<ul class="u-underline-style">
														<li><a href="varsityDeptCourseList.php">বাংলা</a></li>
														<li><a href="varsityDeptCourseList.php">ইংলিশ</a></li> 
														<li><a href="varsityDeptCourseList.php">অর্থনীতি</a></li>
													</ul>
												</div>
			...
			<div class="divider"></div>
				...
				<!-- site slogan start here -->
				<div class='container-fluid site-slogan'>
					<div class='container'>
						<div class='row'>
							<div class="col-lg-offset-3 col-lg-6 col-xs-12 site-slogan-main-col">
							<?php
							...
							?>
								<h3 class="text-center"><?php echo $slogan_one; ?></h3>
								<h5 class="text-center"><?php echo $slogan_two; ?></h5>
								<a href="signup.php"><button class="btn btn-primary col-lg-offset-3 col-lg-6 col-md-offset-4 col-md-4 col-sm-offset-4 col-sm-4 col-xs-offset-4 col-xs-4">সাইন আপ</button></a>
							</div>
						</div>
					</div>
				</div>
				<!-- site slogan end here -->
